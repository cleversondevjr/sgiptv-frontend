...
function abrirFarm() {
  window.open("https://sgiptv.com.br/farm/", "_blank");
}
function abrirFarmTerms() {
  window.open("https://sgiptv.com.br/farm/terms", "_blank");
}
function abrirFarmLogin() {
  window.open("https://sgiptv.com.br/farm/login", "_blank");
}
function abrirFarmRegister() {
